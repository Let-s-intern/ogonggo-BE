...
@Entity
@Table(name = "bootcamp_metrics")
internal class BootcampMetric(
    @Column(name = "bootcamp_id", nullable = false, unique = true)
    val bootcampId: Long, /* 지표 대상 부트캠프 식별자 */
